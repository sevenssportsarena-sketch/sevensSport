        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <select name="status" className="bg-background border border-border rounded-lg px-3 py-2 text-sm outline-none focus:border-primary">
                <option value="draft">Draft</option>
                <option value="published">Published</option>
              </select>
            </div>
            <div className="flex items-center gap-2 mt-2">
              <input type="checkbox" id="is_featured" name="is_featured" className="rounded border-border" />
